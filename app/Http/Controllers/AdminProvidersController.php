<?php namespace App\Http\Controllers;
	...
	class AdminProvidersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Fee','name'=>'fee','type'=>'number','validation'=>'required|integer|min:-100|max:100','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'Name','name'=>'name','type'=>'text','validation'=>'required','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Description','name'=>'description','type'=>'text','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Fee','name'=>'fee','type'=>'number','validation'=>'required|integer|min:0|max:100','width'=>'col-sm-10'];
			# OLD END FORM
